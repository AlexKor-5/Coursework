...
//
//$query = sprintf("SELECT * FROM towns WHERE regions_id = %d", $regions_id);
...
//    $sub_query = sprintf("SELECT images_id FROM images WHERE towns_id = %d", $all_regions[$i]['towns_id']);
            ...
            <div class="regions">
                ...
                <div class="row gy-4">
                    <div class="col-12">
                        ...
                        <!--                                    <input type="hidden" name="towns_id"-->
                        <!--                                           value="-->
                        <?php //echo $all_regions[$i]['towns_id']; ?><!--">-->
                        <!--                                </div>-->
