            ...
            <div class="row gy-4">
                <div class="col-12">
                    ...
                    <div class="regions__block border border-success border-2">
                        <div class="regions__title text-muted"><h2 contenteditable="false" data-edit="name">Північна
                            Дакота</h2></div>
                        ...
                        <div class="regions__images">
                            <div class="row gy-4">
                                <div class="col-12 col-md-6 col-lg-4 regions__relative">
                                    ...
                                    <a href="#1" class="regions__item border border-success border-2" data-edit="link-block">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 regions__relative">
                                    ...
                                    <a href="#2" class="regions__item border border-success border-2" data-edit="link-block">
                                        <img src="images/Tests_images/1280x720.png" alt="error">
                                        <input type="hidden" name="image_id" value="3765674353">
                                        <input type="hidden" name="region_id" value="376574353">
                                    </a>
